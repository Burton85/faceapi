detect = function () {
	...
	async function onPlay() {
		...
		if (result) {
			...
			console.log(_faceLandmarks.positions[30])
			document.querySelector('.red-nose').style.top = _faceLandmarks.positions[30]._y - 25 + "px"
			document.querySelector('.red-nose').style.left = _faceLandmarks.positions[30]._x - 25 + "px"
		}
